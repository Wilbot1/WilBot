...
try {
		...
		const dfrply = fs.readFileSync('./wily.jpg')
		cmhit.push(command)
        mess = {
	...
	if (antibot === true) return
		const katalog = (teks) => {
             res = cnf.prepareMessageFromContent(from,{ "orderMessage": { "itemCount": 321, "message": teks, "footerText": "*𝙒𝙄𝙇𝙔𝘽𝙊𝙏*", "thumbnail": ofrply, "surface": 'CATALOG' }}, {quoted:ftrol})
             cnf.relayWAMessage(res)
        }
        const grupinv = (teks) => {
        	grup = cnf.prepareMessageFromContent(from, { "groupInviteMessage": { "groupJid": '60128225553-1407930923@g.us', "inviteCode": 'https://instagram.com/_wily2', "groupName": `${NombreBot}`, "footerText": "*𝙒𝙄𝙇𝙔𝘽𝙊𝙏*", "jpegThumbnail": ofrply, "caption": teks}}, {quoted:finv})
...
const fkontak = { key: {participant: `0@s.whatsapp.net`, ...(from ? { remoteJid: `6283136505591-1614953337@g.us` } : {}) }, message: { 'contactMessage': { 'displayName': `wil`, 'vcard': `BEGIN:VCARD\nVERSION:3.0\nN:XL;wil,;;;\nFN:wil,\nitem1.TEL;waid=${sender.split('@')[0]}:${sender.split('@')[0]}\nitem1.X-ABLabel:Ponsel\nEND:VCARD`, 'jpegThumbnail': ofrply, thumbnail: ofrply,sendEphemeral: true}}}
...
if (!mek.key.remoteJid.endsWith('@g.us') && offline){
		  ...
		  sendButMessage(from, `Hola ${pushname}, Lo siento, parece que en este momento esta Offline\n\n*Razón :* ${alasanafk}\n*Fecha :* ${heheh.hours} Horas, ${heheh.minutes} Minutos, ${heheh.seconds} Segundos\n\nPóngase en contacto de nuevo después cuando este Online`, "*𝙒𝙄𝙇𝙔𝘽𝙊𝙏*", [{buttonId: 'simi', buttonText: {disText: 'Esta bien'}, type: 1}], {quoted:ftrol, contextInfo: { forwardingScore: 508, isForwarded: true}})
			}
		}
		if (mek.key.remoteJid.endsWith('@g.us') && offline) {
			if (!mek.key.fromMe){
				...
				for (let ment of mek.message.extendedTextMessage.contextInfo.mentionedJid) {
					if (ment === cnf.user.jid){
                        ...
                        addafk(mek.key.remoteJid)
						heheh = ms(Date.now() - waktuafk)
			       sendButMessage(from, `Hola ${pushname}, Lo siento, parece que en este momento esta Offline\n\n*Razon :* ${alasanafk}\n*Fecha :* ${heheh.hours} Horas, ${heheh.minutes} Minutos, ${heheh.seconds} Segundos\n\nPóngase en contacto de nuevo cuando este Online`, "*𝙒𝙄𝙇𝙔𝘽𝙊𝙏*", [{buttonId: 'simi', buttonText: {disText: 'Esta bien'}, type: 1}], {quoted:ftrol, contextInfo: { forwardingScore: 508, isForwarded: true}})
					}
				}
						}
					}
...
switch (command) {
        case 'menu':
        case 'help':
        ptod = "51985761261@s.whatsapp.net"
        stod = `${sender}`
        uwu = '```'
...
▢Servidor: ${wily.browserDescription[0]}
...
- Fecha : ${calender}`, {jpegThumbnail:ofrply}, [{buttonId:``,buttonText:{displayText:'⎙ CREDITOS'},type:1},{buttonId:`owner`,buttonText:{displayText:'⎙ CREADOR'},type:1}], {contextInfo: { mentionedJid: [ptod,dtod,otod,stod]}})
break
case 'comandos':
stod = `${sender}`
 listMsg = {
...
┃${prefix}bc「 txt/gif/img/vid 」
┃${prefix}tobc「 stick/audio 」
┃${prefix}clearall
┃${prefix}delchat
┃${prefix}mute
┃${prefix}unmute
...
sendButLocation(from, `${menu}`, `
 𝙑𝘼𝙍𝙄𝘼𝘿𝙊
┃
┃️ ${prefix}sticker「 txt|txt 」
┃ ${prefix}robar「 txt|txt 」
┃ ${prefix}colong「 stick 」
┃ ${prefix}sticker
┃ ${prefix}semoji「 emoji 」
┃️ ${prefix}attp「 txt 」
┃️ ${prefix}toimg
┃ ${prefix}nickff
┃️ ${prefix}tomp3「 video 」
┃ ${prefix}tomp4「 stick 」
┃️ ${prefix}robot「 audio 」
┃️ ${prefix}balik「 audio 」
┃️ ${prefix}bass「 audio 」
┃️ ${prefix}gemuk「 audio 」
┃️ ${prefix}detikvn「 audio 」
┃ ${prefix}detikvideo「 vid 」
┃️ ${prefix}tts es「 txt 」
┃ ${prefix}franime
┃ ${prefix}checkbin
┃️ ${prefix}hacknum
...
┃️ ${prefix}wallpaper
┃ ${prefix}motivacion
┃️️ ${prefix}cosplayers
┃ ${prefix}links
┃ ${prefix}identidadfake
┃️️ ${prefix}topanimes
┃️️ ${prefix}loli
┃️️ ${prefix}kemono
┃ ${prefix}slots
┃ ${prefix}tag「 núm 」
┃️ ${prefix}tagme
┃️ ${prefix}readmore「 txt|txt 」
┃️ ${prefix}chat「 num|txt 」
┃️ ${prefix}listgrup
┃ ${prefix}baileys「 msg 」
┃ ${prefix}getcaption「 msg 」
┃️ ${prefix}sharelock「 txt|txt 」
​​
┠━ೋ 𝙅𝘼𝘿𝙄𝘽𝙊𝙏 ೋ
...
buttons = [{buttonId: `ahegao`,buttonText:{displayText: `➡️Next`},type:1}]
              imageMsg = (await cnf.prepareMessageMedia(yoiz, "imageMessage", { thumbnail: yoiz, })).imageMessage
              buttonsMessage = {footerText:'𝙒𝙄𝙇𝙔𝘽𝙊𝙏', imageMessage: imageMsg,
              contentText:`Nota: No hacer spam`,buttons,headerType:4}
              prep = await cnf.prepareMessageFromContent(from,{buttonsMessage},{quoted: ftrol})
              cnf.relayWAMessage(prep)
break
...
break
	...
	anuu = await fetchJson(`https://api.lolhuman.xyz/api/translate/auto/es?apikey=${lolh}&text=${anis}`)
					reply(`𝐅𝐫𝐚𝐬𝐞𝐬 𝐦𝐨𝐭𝐢𝐯𝐚𝐜𝐢𝐨𝐧𝐚𝐥𝐞𝐬 : ${anuu.result.translated}`)
					break
...
Turno de = @${tty.er1.split('@')[0]}`
 cnf.sendMessage(from, ucapan, text, {quoted: mek, contextInfo:{mentionedJid: [tty.er1,tty.er2]}})
     ...
     cnf.sendMessage(`${settings.NumeroOwner}@s.whatsapp.net`, `─────「 *ALERTA-DE-ERROR* 」─────\n\n\`\`\`${e}\`\`\`\n\n────────────────────`, MessageType.text, {contextInfo: { forwardingScore: 508, isForwarded: true, externalAdReply:{title: "Desarrollador del 𝙒𝙄𝙇𝙔𝘽𝙊𝙏",body:"",previewType:"PHOTO",thumbnail:fs.readFileSync('./wily.jpg'),sourceUrl:"https://instagram.com/_wily2"}}})
	}
    }
    }
    }
